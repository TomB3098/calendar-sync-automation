...
class AppSettings:
    ...
    def from_env(cls) -> "AppSettings":
        ...
        return cls(
            ...
            google_oauth_client_id=_env_first("CAL_WEBAPP_GOOGLE_OAUTH_CLIENT_ID", "GOOGLE_OAUTH_CLIENT_ID", default=""),
            google_oauth_client_secret=_env_first("CAL_WEBAPP_GOOGLE_OAUTH_CLIENT_SECRET", "GOOGLE_OAUTH_CLIENT_SECRET", default=""),
